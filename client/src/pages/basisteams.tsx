...
const BasisteamsPage: React.FC = () => {
  const [activeSection, setActiveSection] = useState("basisteams");
      ...
      <div className="flex-1 flex bg-gray-50">
        ...
        <div className="w-80 bg-white border-r border-gray-200 flex flex-col">
          <div className="p-4 border-b border-gray-200">
            <h1 className="text-xl font-bold text-gray-900">🏢 Basisteams</h1>
            <p className="text-gray-600 text-sm mt-1">Beheer politie basisteams en hun gebieden</p>
            <button
