              ...
              <div className="intake-content">
                <div className="intake-info-panel">
                  ...
                  <div className="intake-instructions">
                    ...
                    <ol>
                      <li>Ontvang en registreer melding via telefoon (112/0900-8844)</li>
                      <li>Verzamel basisgegevens: locatie, type incident, urgentie</li>
                      <li>Beoordeel prioriteit en classificeer volgens MC-codes</li>
                  ...
                  <div className="recent-calls-list">
                    ...
                    <div className="call-item">
                      ...
                      <div className="call-details">
                        ...
                        <div className="call-location">Coolsingel 42, Rotterdam</div>
                      </div>
                      <div className="call-status processing">In behandeling</div>
                    </div>
                    <div className="call-item">
                      <div className="call-time">22:18</div>
                      <div className="call-details">
                        <div className="call-type">Overlast</div>
                        <div className="call-location">Marktplein, Vlaardingen</div>
                      </div>
                      <div className="call-status completed">Doorgestuurd</div>
                    </div>
                    <div className="call-item">
                      ...
                      <div className="call-details">
                        ...
                        <div className="call-location">Bergweg 156, Rotterdam</div>
                      </div>
                      <div className="call-status completed">Doorgestuurd</div>
                    </div>
                  </div>
